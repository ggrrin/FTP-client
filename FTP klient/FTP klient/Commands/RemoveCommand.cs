...
// ***********************************************************************
// <copyright file="RemoveCommand.cs" company="">
//     Copyright ©  2015
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
	/// <summary>
	/// Represents command for removing of server file
	/// </summary>
	public class RemoveCommand : IInterpreter
	{
		/// <summary>
		...
		public bool Run()
		{
			...
			try
			{
				AppContext.Control.ExecuteQuery(new DeleteFileQuery { FileServerPath = path });
				Output.WriteLine("Delete succeed.");
			}
