...
// ***********************************************************************
// <copyright file="RMDCommand.cs" company="">
//     Copyright ©  2015
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
	/// <summary>
	/// Represents command for removing of server directory
	/// </summary>
	public class RMDCommand : IInterpreter
	{
		/// <summary>
		...
		public bool Run()
		{
			...
			Output.WriteLine("Write server directory path:");
			...
			try
			{
				AppContext.Control.ExecuteQuery(new DirectoryQuery { RemoveDirectory = true, Path = path });
				Output.WriteLine("Directory removed successfully.");
			}
