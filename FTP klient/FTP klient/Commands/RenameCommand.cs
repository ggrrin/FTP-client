...
// ***********************************************************************
// <copyright file="RenameCommand.cs" company="">
//     Copyright ©  2015
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace FTPClient.Commands
{
	...
	/// Class RenameCommand.
	/// </summary>
	public class RenameCommand : IInterpreter
	{
		/// <summary>
		...
		public bool Run()
		{
			...
			Output.WriteLine("Write server file path:");
			...
			Output.WriteLine("Write new file path:");
			string newPath = Input.ReadLine().Trim();
			...
			try
			{
				AppContext.Control.ExecuteQuery(new RenamePathQuery { ServerPath = path, NewServerPath = newPath });
				Output.WriteLine("Rename succeed.");
			}
